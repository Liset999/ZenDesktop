// ==WindhawkMod==
// @id              zen-fileexplorer-acrylic
// @name            ZenDesktop: File Explorer Styler
// @description     ZenDesktop full-window File Explorer styling based on m417z's Windows 11 File Explorer Styler
// @version         3.8.0
// @author          m417z, Lanbo
...
// ==WindhawkModReadme==
/*
# ZenDesktop: File Explorer Styler

ZenDesktop-localized build of **Windows 11 File Explorer Styler** with the
default behavior tuned for full-window translucent Explorer.
...
- theme: "CustomGlass"
  ...
  - "": 无 (None)
  - CustomGlass: 去文留图
  - Translucent Explorer11: 原版全透
  - LiquidGlass: 无图留文
- backgroundTranslucentEffect: "acrylic"
  $name: 背景材质 (Backdrop)
  $description: >-
    文件管理器背景使用的系统材质。亚克力自带磨砂模糊；“无”为完全透明无模糊。
  $options:
  - "": 跟随主题默认
  - default: Windows 默认
  - acrylic: 亚克力 (Acrylic)
  - mica: 云母 (Mica)
  - micaAlt: 云母变体 (Mica Alt)
  - none: 无 (None)
- zenCustomColorMode: "Default"
  $name: 玻璃颜色 (Color)
  $description: >-
    仅在“去文留图”主题下使用。选择玻璃底色基调。
  $options:
  - Default: 主题默认
  - Accent: 跟随系统强调色
  - GlassWhite: 晶莹透白
  ...
  - ChampagneGold: 香槟金黄
  - MorandiSage: 莫兰迪绿
- zenCustomTintOpacity: 0
  $name: 玻璃色彩浓度 (Tint Opacity %)
  $description: >-
    0 尽量全透，数值越大底色越明显。
- zenWholeWindowAlpha: 0
  $name: 整窗前景透明度 (Window Transparency %)
  $description: >-
    可选新功能。0 保持文字和图标不透明；大于 0 时整个窗口连同文字一起变透明（数值越大越透明）。
- styleConstants: [""]
...
DWORD WINAPI AdviseVisualTreeChangeThreadProc(LPVOID lpParam);
extern UINT g_runFromWindowThreadRegisteredMsg;
LRESULT CALLBACK RunFromWindowThreadHookProc(int nCode,
                                             WPARAM wParam,
                                             LPARAM lParam);
BOOL CALLBACK EnumTargetWndsProc(HWND hWnd, LPARAM lParam);
void WINAPI InitializeTargetWindowProc(PVOID param);
void WINAPI UninitializeTargetWindowProc(PVOID param);
void WINAPI ReinitializeTargetWindowProc(PVOID param);
void ApplyZenDesktopWindowAlpha(HWND hWnd, bool forceDisable = false);
...
const Theme g_themeTranslucent_Explorer11 = {{
    ...
    ThemeTargetStyles{L"StackPanel#DetailsViewThumbnail > Grid", {
        ...
        L"BorderThickness=0",
        L"BorderBrush=Transparent"}},
    ThemeTargetStyles{L"Microsoft.UI.Xaml.Controls.Primitives.ListViewHeaderItemPresenter", {
        L"Background=Transparent",
        L"BorderBrush=Transparent",
        L"BorderThickness=0"}},
    ThemeTargetStyles{L"Microsoft.UI.Xaml.Controls.ListViewHeaderItem", {
        L"Background=Transparent",
        L"BorderBrush=Transparent",
        L"BorderThickness=0"}},
    ThemeTargetStyles{L"Microsoft.UI.Xaml.Controls.Primitives.GridViewHeaderItemPresenter", {
        L"Background=Transparent",
        L"BorderBrush=Transparent",
        L"BorderThickness=0"}},
}, {}, {
    L"ListViewHeaderItemPresenterBackground@Dark:=<SolidColorBrush Color=\"Transparent\"/>",
    L"ListViewHeaderItemPresenterBackground@Light:=<SolidColorBrush Color=\"Transparent\"/>",
    L"ListViewHeaderItemPresenterBorderBrush@Dark:=<SolidColorBrush Color=\"Transparent\"/>",
    L"ListViewHeaderItemPresenterBorderBrush@Light:=<SolidColorBrush Color=\"Transparent\"/>",
    L"ListViewHeaderItemPresenterBorderThickness@Dark:=0",
    L"ListViewHeaderItemPresenterBorderThickness@Light:=0",
    L"GridViewHeaderItemPresenterBackground@Dark:=<SolidColorBrush Color=\"Transparent\"/>",
    L"GridViewHeaderItemPresenterBackground@Light:=<SolidColorBrush Color=\"Transparent\"/>",
    L"GridViewHeaderItemPresenterBorderBrush@Dark:=<SolidColorBrush Color=\"Transparent\"/>",
    L"GridViewHeaderItemPresenterBorderBrush@Light:=<SolidColorBrush Color=\"Transparent\"/>",
    L"GridViewHeaderItemPresenterBorderThickness@Dark:=0",
    L"GridViewHeaderItemPresenterBorderThickness@Light:=0",
    L"ListViewHeaderItemBackground@Dark:=<SolidColorBrush Color=\"Transparent\"/>",
    L"ListViewHeaderItemBackground@Light:=<SolidColorBrush Color=\"Transparent\"/>",
    L"ListViewHeaderItemBorderBrush@Dark:=<SolidColorBrush Color=\"Transparent\"/>",
    L"ListViewHeaderItemBorderBrush@Light:=<SolidColorBrush Color=\"Transparent\"/>",
    L"ListViewHeaderItemBorderThickness@Dark:=0",
    L"ListViewHeaderItemBorderThickness@Light:=0",
    L"ListViewBorderBrush@Dark:=<SolidColorBrush Color=\"Transparent\"/>",
    L"ListViewBorderBrush@Light:=<SolidColorBrush Color=\"Transparent\"/>",
    L"ListViewBorderThickness@Dark:=0",
    L"ListViewBorderThickness@Light:=0",
    L"ItemsViewBorderBrush@Dark:=<SolidColorBrush Color=\"Transparent\"/>",
    L"ItemsViewBorderBrush@Light:=<SolidColorBrush Color=\"Transparent\"/>",
    L"ItemsViewBorderThickness@Dark:=0",
    L"ItemsViewBorderThickness@Light:=0",
    L"NavigationViewBorderBrush@Dark:=<SolidColorBrush Color=\"Transparent\"/>",
    L"NavigationViewBorderBrush@Light:=<SolidColorBrush Color=\"Transparent\"/>",
    L"SplitViewPaneBorderBrush@Dark:=<SolidColorBrush Color=\"Transparent\"/>",
    L"SplitViewPaneBorderBrush@Light:=<SolidColorBrush Color=\"Transparent\"/>",
...
struct {
    ...
    int zenCustomBlurAmount;
    int zenCustomTintOpacity;
    int zenCustomTintLuminosityOpacity;
    int zenWholeWindowAlpha;
...
bool g_useZenDesktopCustomGlass = false;
...
public:
    ...
    friend DWORD WINAPI AdviseVisualTreeChangeThreadProc(LPVOID lpParam);
...
std::wstring FormatPercentString(int value) {
    float percent = std::clamp(value, 0, 100) / 100.0f;
    wchar_t buffer[16];
...
std::wstring ResolveZenCustomTintColor(std::wstring_view colorMode) {
    if (colorMode == L"Accent") {
        return L"{ThemeResource SystemAccentColorLight1}";
    }
    if (colorMode == L"GlassWhite") {
        return L"#F0FFFFFF";
    }
    if (colorMode == L"MistGrey") {
        return L"#F0323232";
    }
    if (colorMode == L"DeepBlack") {
        return L"#F0121214";
    }
    if (colorMode == L"OceanBlue") {
        return L"#F0081E3A";
    }
    if (colorMode == L"AuroraCyan") {
        return L"#F0043438";
    }
    if (colorMode == L"RosePink") {
        return L"#F03A1424";
    }
    if (colorMode == L"BordeauxRed") {
        return L"#F03A050B";
    }
    if (colorMode == L"ForestGreen") {
        return L"#F00C2A1A";
    }
    if (colorMode == L"RoyalPurple") {
        return L"#F01F0E3D";
    }
    if (colorMode == L"SunsetOrange") {
        return L"#F04C1A05";
    }
    if (colorMode == L"ChampagneGold") {
        return L"#F03A2A05";
    }
    if (colorMode == L"MorandiSage") {
        return L"#F02C3A32";
    }
...
void AddStyleConstantOverride(StyleConstants& result,
                              std::wstring name,
                              std::wstring value) {
    auto insertIndex = std::lower_bound(
        result.begin(), result.end(), StyleConstant{name, value},
        [](const StyleConstant& a, const StyleConstant& b) {
            return a.first.size() > b.first.size();
        });

    result.insert(insertIndex, StyleConstant{std::move(name), std::move(value)});
}
...
const Theme* GetSelectedTheme() {
    ...
    g_useZenDesktopCustomGlass = false;

    if (!themeName || !*themeName) {
        // 空 = None，不应用任何主题
        theme = nullptr;
    } else if (wcscmp(themeName, L"CustomGlass") == 0) {
        g_useZenDesktopCustomGlass = true;
        theme = &g_themeWindowGlass;
    } else if (wcscmp(themeName, L"Translucent Explorer11") == 0 ||
               wcscmp(themeName, L"Clear") == 0) {
        theme = &g_themeTranslucent_Explorer11;
    } else if (wcscmp(themeName, L"LiquidGlass") == 0 ||
               wcscmp(themeName, L"CustomLiquidGlass") == 0) {
        theme = &g_themeLiquidGlass;
    }
    // 向下兼容旧值：其他任何不认识的字符串（如 WindowGlass, MicaBar 等）→回退到 CustomGlass
...
void ProcessAllStylesFromSettings() {
    ...
    if (g_useZenDesktopCustomGlass) {
        string_setting_unique_ptr colorModeSetting(
            Wh_GetStringSetting(L"zenCustomColorMode"));
        std::wstring tintColor =
            ResolveZenCustomTintColor(colorModeSetting.get());
        int tintOpacityValue = std::clamp(g_settings.zenCustomTintOpacity, 0, 100);
        std::wstring tintOpacity = FormatPercentString(tintOpacityValue);
        std::wstring elementTintOpacity =
            FormatPercentString(std::clamp(tintOpacityValue + 8, 0, 100));
        std::wstring accentTintOpacity =
            FormatPercentString(std::clamp(tintOpacityValue + 14, 0, 100));

        std::wstring backgroundGlassBrush =
            std::wstring(L"<SolidColorBrush Color=\"") + tintColor +
            L"\" Opacity=\"" + tintOpacity + L"\" />";
        std::wstring elementGlassBrush =
            std::wstring(L"<SolidColorBrush Color=\"") + tintColor +
            L"\" Opacity=\"" + elementTintOpacity + L"\" />";
        std::wstring accentGlassBrush =
            std::wstring(L"<SolidColorBrush Color=\"{ThemeResource SystemAccentColorLight1}\" Opacity=\"") +
            accentTintOpacity + L"\" />";

        AddStyleConstantOverride(styleConstants, L"Background", backgroundGlassBrush);
        AddStyleConstantOverride(styleConstants, L"MainContentBG", backgroundGlassBrush);
        AddStyleConstantOverride(styleConstants, L"Background2", backgroundGlassBrush);
        AddStyleConstantOverride(styleConstants, L"CommonBgBrush", backgroundGlassBrush);
        AddStyleConstantOverride(styleConstants, L"ElementBG", elementGlassBrush);
        AddStyleConstantOverride(styleConstants, L"ClockBG", accentGlassBrush);
        AddStyleConstantOverride(styleConstants, L"ButtonBackground", accentGlassBrush);
    }
...
void OnWindowCreated(HWND hWnd, PCSTR funcName) {
    ...
    if (windowType != TargetWindowType::None) {
        ...
        if (windowType == TargetWindowType::FileExplorer) {
            ...
            ApplyZenDesktopWindowAlpha(hWnd);
        }
...
bool RunFromWindowThread(HWND hWnd,
    ...
    SendMessage(hWnd, g_runFromWindowThreadRegisteredMsg, 0, (LPARAM)&param);
...
std::vector<HWND> GetTargetWnds() {
    ...
    EnumWindows(EnumTargetWndsProc, (LPARAM)&hWnds);
...
constexpr WCHAR kZenDesktopWindowAlphaAppliedProp[] =
    L"ZenDesktopFileExplorerWindowAlphaApplied";
constexpr WCHAR kZenDesktopWindowAlphaAddedLayeredProp[] =
    L"ZenDesktopFileExplorerWindowAlphaAddedLayered";

BYTE GetZenDesktopWindowAlpha() {
    int wholeWindowAlpha = std::clamp(g_settings.zenWholeWindowAlpha, 0, 100);
    int alphaPercent = 100 - wholeWindowAlpha;
    return static_cast<BYTE>(std::clamp(alphaPercent * 255 / 100, 0, 255));
}

void ApplyZenDesktopWindowAlpha(HWND hWnd, bool forceDisable) {
    const bool useWholeWindowAlpha =
        g_useZenDesktopCustomGlass &&
        std::clamp(g_settings.zenWholeWindowAlpha, 0, 100) > 0;

    if (forceDisable || !useWholeWindowAlpha) {
        if (RemoveProp(hWnd, kZenDesktopWindowAlphaAppliedProp)) {
            SetLayeredWindowAttributes(hWnd, 0, 255, LWA_ALPHA);

            if (RemoveProp(hWnd, kZenDesktopWindowAlphaAddedLayeredProp)) {
    ...
    if (!(exStyle & WS_EX_LAYERED)) {
        ...
        SetWindowPos(hWnd, nullptr, 0, 0, 0, 0,
                     SWP_NOMOVE | SWP_NOSIZE | SWP_NOZORDER |
                         SWP_NOACTIVATE | SWP_FRAMECHANGED);
        SetProp(hWnd, kZenDesktopWindowAlphaAddedLayeredProp, (HANDLE)1);
    }

    SetLayeredWindowAttributes(hWnd, 0, GetZenDesktopWindowAlpha(), LWA_ALPHA);
    SetProp(hWnd, kZenDesktopWindowAlphaAppliedProp, (HANDLE)1);
}

DWORD WINAPI AdviseVisualTreeChangeThreadProc(LPVOID lpParam) {
    auto watcher = reinterpret_cast<VisualTreeWatcher*>(lpParam);
    HRESULT hr =
        watcher->m_XamlDiagnostics.as<IVisualTreeService3>()->AdviseVisualTreeChange(watcher);
    watcher->Release();
    if (FAILED(hr)) {
        Wh_Log(L"Error %08X", hr);
    }
...
UINT g_runFromWindowThreadRegisteredMsg = 0;
...
LRESULT CALLBACK RunFromWindowThreadHookProc(int nCode,
    ...
    if (nCode == HC_ACTION) {
        ...
        if (cwp->message == g_runFromWindowThreadRegisteredMsg) {
            RunFromWindowThreadParam* param =
                (RunFromWindowThreadParam*)cwp->lParam;
...
BOOL CALLBACK EnumTargetWndsProc(HWND hWnd, LPARAM lParam) {
    auto& param = *(std::vector<HWND>*)lParam;
...
void WINAPI InitializeTargetWindowProc(PVOID param) {
    ...
    if (GetTargetWindowType(hTargetWnd) == TargetWindowType::FileExplorer) {
        ApplyBackgroundTranslucentEffect(hTargetWnd);
        ApplyZenDesktopWindowAlpha(hTargetWnd);
...
void WINAPI UninitializeTargetWindowProc(PVOID param) {
    ...
    if (GetTargetWindowType(hTargetWnd) == TargetWindowType::FileExplorer) {
        ApplyZenDesktopWindowAlpha(hTargetWnd, true);
...
std::mutex g_themeClassesMutex;
std::unordered_map<HTHEME, std::wstring> g_themeClasses;

void RegisterThemeHandle(HTHEME hTheme, LPCWSTR pszClassList) {
    if (!hTheme || !pszClassList) return;
    std::wstring classList(pszClassList);
    std::transform(classList.begin(), classList.end(), classList.begin(), ::towlower);
    std::lock_guard<std::mutex> lock(g_themeClassesMutex);
    g_themeClasses[hTheme] = classList;
}

void UnregisterThemeHandle(HTHEME hTheme) {
    if (!hTheme) return;
    std::lock_guard<std::mutex> lock(g_themeClassesMutex);
    g_themeClasses.erase(hTheme);
}

std::wstring GetThemeClassList(HTHEME hTheme) {
    std::lock_guard<std::mutex> lock(g_themeClassesMutex);
...
bool ShouldBypassThemeBackground(HTHEME hTheme, int iPartId) {
    std::wstring classList = GetThemeClassList(hTheme);
    if (classList.empty()) {
        return false;
    }

    if (classList.find(L"header") != std::wstring::npos) {
        if (iPartId != 4 && iPartId != 6) {
            return true;
        }
    }

    if (classList.find(L"splitter") != std::wstring::npos) {
        return true;
    }

    if (classList.find(L"rebar") != std::wstring::npos) {
        if (iPartId == 7 || iPartId == 8) { // RP_SPLITTER or RP_SPLITTERVERT
            return true;
        }
    }

    if (classList.find(L"toolbar") != std::wstring::npos) {
        if (iPartId == 5 || iPartId == 6) { // TP_SEPARATOR or TP_SEPARATORVERT
            return true;
        }
    }

    if (classList.find(L"listview") != std::wstring::npos ||
        classList.find(L"itemsview") != std::wstring::npos) {
        if (iPartId == 0 || iPartId == 3 || iPartId == 4) { // Background/border and Details columns/sorted backgrounds
            return true;
        }
    }

    if (classList.find(L"treeview") != std::wstring::npos ||
        classList.find(L"sidebar") != std::wstring::npos ||
        classList.find(L"navigation") != std::wstring::npos) {
        if (iPartId == 0) {
            return true;
        }
    }
...
OpenThemeData_t OpenThemeData_Original;
HTHEME WINAPI OpenThemeData_Hook(HWND hwnd, LPCWSTR pszClassList) {
    ...
    if (hTheme && pszClassList) {
        RegisterThemeHandle(hTheme, pszClassList);
    }
    return hTheme;
}

using OpenThemeDataForDpi_t = HTHEME(WINAPI*)(HWND, LPCWSTR, UINT);
OpenThemeDataForDpi_t OpenThemeDataForDpi_Original;
...
CloseThemeData_t CloseThemeData_Original;
HRESULT WINAPI CloseThemeData_Hook(HTHEME hTheme) {
    if (hTheme) {
        UnregisterThemeHandle(hTheme);
    }
...
HRESULT WINAPI DrawThemeBackground_Hook(HTHEME hTheme, HDC hdc, int iPartId, int iStateId, const RECT* pRect, const RECT* pClipRect) {
    if (hTheme && ShouldBypassThemeBackground(hTheme, iPartId)) {
        return S_OK;
    }
...
void LoadSettings() {
    ...
    g_settings.zenCustomBlurAmount = 18;
    g_settings.zenCustomTintOpacity =
        std::clamp(Wh_GetIntSetting(L"zenCustomTintOpacity"), 0, 100);
    g_settings.zenCustomTintLuminosityOpacity = 0;
    g_settings.zenWholeWindowAlpha =
        std::clamp(Wh_GetIntSetting(L"zenWholeWindowAlpha"), 0, 100);
...
BOOL Wh_ModInit() {
    ...
    if (uxthemeModule) {
        auto pOpenThemeData = (OpenThemeData_t)GetProcAddress(uxthemeModule, "OpenThemeData");
        if (pOpenThemeData) {
            WindhawkUtils::SetFunctionHook(pOpenThemeData, OpenThemeData_Hook, &OpenThemeData_Original);
        }
        auto pOpenThemeDataForDpi = (OpenThemeDataForDpi_t)GetProcAddress(uxthemeModule, "OpenThemeDataForDpi");
        if (pOpenThemeDataForDpi) {
            WindhawkUtils::SetFunctionHook(pOpenThemeDataForDpi, OpenThemeDataForDpi_Hook, &OpenThemeDataForDpi_Original);
        }
        auto pCloseThemeData = (CloseThemeData_t)GetProcAddress(uxthemeModule, "CloseThemeData");
        if (pCloseThemeData) {
            WindhawkUtils::SetFunctionHook(pCloseThemeData, CloseThemeData_Hook, &CloseThemeData_Original);
        }
        auto pDrawThemeBackground = (DrawThemeBackground_t)GetProcAddress(uxthemeModule, "DrawThemeBackground");
        if (pDrawThemeBackground) {
            WindhawkUtils::SetFunctionHook(pDrawThemeBackground, DrawThemeBackground_Hook, &DrawThemeBackground_Original);
        }
        auto pDrawThemeBackgroundEx = (DrawThemeBackgroundEx_t)GetProcAddress(uxthemeModule, "DrawThemeBackgroundEx");
        if (pDrawThemeBackgroundEx) {
            WindhawkUtils::SetFunctionHook(pDrawThemeBackgroundEx, DrawThemeBackgroundEx_Hook, &DrawThemeBackgroundEx_Original);
        }
    }
...
void Wh_ModAfterInit() {
    ...
    for (auto hTargetWnd : hTargetWnds) {
        ...
        RunFromWindowThread(hTargetWnd,
                            InitializeTargetWindowProc,
                            (PVOID)hTargetWnd);
    }
