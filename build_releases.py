...
releases = {
    'ZenDesktop_OneKeyDeploy_v4.0.zip': common_files + ['windhawk_setup.exe'],
    'ZenDesktop_OneKeyDeploy_v4.0_Offline.zip': common_files + ['windhawk_setup_offline.exe'],
    'ZenDesktop_OneKeyDeploy_v4.0_Online.zip': common_files
}
