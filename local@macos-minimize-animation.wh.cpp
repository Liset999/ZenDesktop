...
// ==WindhawkModReadme==
/*
# macOS Genie Minimize Animation for Windows

Brings the iconic macOS-style genie minimize and restore (open) animations to every window on Windows 11/10.

### Features:
- **Genie Funnel Effect**: Windows warp and shrink smoothly into their taskbar icons.
- **Smart Icon Tracking**: Automatically learns where app taskbar icons live by tracking mouse click coordinates.
- **DWM Cloaking**: Restores windows invisibly behind the scenes to prevent window-frame flashing.
- **Multi-Monitor Support**: Leverages current window coordinates to warp to correct screen edges.
- **DLL Unload Safety**: Cooperatively shuts down worker threads during updates or disables to avoid crashes.
*/
// ==/WindhawkModReadme==
...
- duration_ms: 450
  ...
  $name:zh-CN: 动画时长 (毫秒)
  $description: "The time it takes for the genie animation to complete. Range: 50-2000ms."
  $description:zh-CN: "神奇效果动画完成所需的时间。范围：50-2000毫秒。"
- open_animation: true
  $name: Enable Restore Animation
  $name:zh-CN: 启用还原动画
  $description: "When enabled, windows will slide out of the dock when restored."
  $description:zh-CN: "启用时，窗口还原时会从小图标飞出展开。"
- launch_animation: false
  $name: Enable App Launch Animation
  $name:zh-CN: 启用应用启动动画
  $description: "When enabled, brand new windows will slide out of the dock when launched."
  $description:zh-CN: "启用时，新打开的应用窗口也会从图标飞出。"
- multi_monitor: false
  $name: Multi-Monitor Support
  $name:zh-CN: 多显示器支持
  $description: "Enable multi-monitor support so the genie flows to the window's current monitor."
  $description:zh-CN: "启用多显示器支持，使神奇效果飞入窗口所在的显示器任务栏。"
*/
// ==/WindhawkModSettings==
