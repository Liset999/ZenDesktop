// ==WindhawkMod==
// @id              zen-explorer-system-menu
// @name            ZenDesktop: Explorer System Menu Behavior
// @name:zh-CN      ZenDesktop：资源管理器系统菜单行为
// @description     Restores classic Explorer window-icon system menu behavior.
// @description:zh-CN 恢复资源管理器窗口图标的经典系统菜单行为，可右键打开当前文件夹菜单并支持拖拽创建快捷方式。
// @version         3.5.0
// @author          aubymori, Lanbo
// @github          https://github.com/aubymori, https://github.com/Liset999
...
// ==WindhawkModReadme==
/*
# ZenDesktop: Explorer System Menu Behavior
Restores classic behavior for the File Explorer window icon:
- Drag the icon to create a shortcut to the current folder.
- Right-click the icon to show a context menu for the current folder.
- Left-click menu placement follows the classic delayed cursor-position behavior.

Based on aubymori's Old Explorer System Menu Behavior community mod.
*/
// ==/WindhawkModReadme==
